...
%%%%%%%%  ML %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 list_of_stocks= pl(dayindex,:);  
%%%%%%% Random %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 %list_of_stocks= randint(1,8);  
...
elseif(x(2)==1)
 ...
 profit(dayindex)= closeall(dayindex+1, selectedstocks(1)) - closeall(dayindex, selectedstocks(1));   
...
Prices=c;
   ...
   for p= 1:x(2)
     %profit(dayindex)
     profit(dayindex) = profit(dayindex) + weights(p)*( closeall(dayindex+1, selectedstocks(p)) - closeall(dayindex, selectedstocks(p)) );
