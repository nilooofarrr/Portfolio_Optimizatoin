function [predictedtarget TestingAccuracy] = elm(TrainingData_File, TestingData_File, Elm_Type, NumberofHiddenNeurons, ActivationFunction)
...
%%%%%%%%%% Calculate training & testing classification accuracy
    ...
    for i = 1 : size(TV.T, 2)
        ...
        predictedtarget(i)= label_index_expected;
